    ...
    <div style="width:260px; background:white; border-right:1px solid #eee; display:flex; flex-direction:column; justify-content:space-between;">
        ...
        <div>
            ...
            <ul class="nav flex-column px-3">
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link bg-success text-white rounded px-3 py-2" href="/seller/products">
                        Kelola Produk
                    </a>
                </li>
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link text-dark" href="/seller/chat">
                        Chat Pembeli
                    </a>
                </li>
        ...
        <div class="px-3 pb-4">
            <hr>
            <a class="nav-link text-muted" href="/seller/store-profile/show">
                Profil Toko
            </a>
        </div>
