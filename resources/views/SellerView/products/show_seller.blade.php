...
<div class="d-flex" style="min-height:100vh; background:#f9fafb;">
    ...
    <div style="width:260px; background:white; border-right:1px solid #eee; display:flex; flex-direction:column; justify-content:space-between;">
        ...
        <div>
            ...
            <ul class="nav flex-column px-3">
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link {{ request()->routeIs('seller.products*') ? 'bg-success text-white rounded px-3 py-2' : 'text-dark' }}"
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link {{ request()->routeIs('seller.orders*') ? 'bg-success text-white rounded px-3 py-2' : 'text-dark' }}"
                    href="/seller/orders">
                    Pesanan Baru
                    </a>
                </li>
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link {{ request()->routeIs('seller.rentals*') ? 'bg-success text-white rounded px-3 py-2' : 'text-dark' }}"
                    href="/seller/rentals">
                    Penyewaan Alat
                    </a>
                </li>
                ...
                {{-- CHAT TETAP DI ATAS --}}
                <li class="nav-item mb-2">
                    <a class="nav-link {{ request()->routeIs('seller.chat*') ? 'bg-success text-white rounded px-3 py-2' : 'text-dark' }}"
                    href="/seller/chat">
                    Chat Pembeli
                    </a>
                </li>
        ...
        <div class="px-3 pb-4">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('seller.store-profile*') ? 'bg-success text-white rounded px-3 py-2' : 'text-dark' }}"
    ...
    <div class="flex-grow-1 p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="/seller/products" class="btn btn-outline-secondary rounded-pill">Kembali</a>
        </div>
