            ...
            <form action="#" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-lg font-bold text-slate-900">Rp 0</p>
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-slate-200 rounded-2xl p-8 text-center hover:border-emerald-400 transition cursor-pointer">
                        <p class="text-sm text-slate-500">Klik atau seret file gambar bukti bayar denda ke sini</p>
                    </div>
                </div>
